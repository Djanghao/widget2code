...
The following pre-built components are available for utilities widgets. You can reference these components by their exact ID to ensure consistent styling and behavior.

### Button Components

#### utilities-button-settings
- **Category**: button
...
- **Content**: "Settings"
- **Tags**: button, action, action, settings
- **Semantic Fit**: header,footer,content

### Composite Components

#### utilities-composite-battery-status
- **Category**: composite
- **Component Type**: undefined
- **Tags**: composite, battery, status
- **Semantic Fit**: content,header

#### utilities-composite-wifi-status
- **Category**: composite
- **Component Type**: undefined
- **Tags**: composite, wifi, status
- **Semantic Fit**: content,header

#### utilities-composite-storage
- **Category**: composite
- **Component Type**: undefined
- **Tags**: composite, storage, progress
- **Semantic Fit**: content,header

### Icon Components

#### utilities-icon-battery-full
- **Category**: icon
- **Component Type**: Icon
- **Props**: {
  "name": "sf:battery.100percent",
  "size": 24,
  "color": "#34C759"
}
- **Tags**: icon, battery
...
#### utilities-icon-battery-low
- **Category**: icon
- **Component Type**: Icon
- **Props**: {
  "name": "sf:battery.25percent",
  "size": 24,
  "color": "#FF3B30"
}
- **Tags**: icon, battery, low
- **Semantic Fit**: header,content,sidebar
...
- **Tags**: icon, power, charging
- **Semantic Fit**: header,content,sidebar

### Progress Components

#### utilities-progress-battery
- **Category**: progress
...
- **Tags**: progress, bar, battery
- **Semantic Fit**: content

#### utilities-progress-storage
- **Category**: progress
- **Component Type**: ProgressBar
- **Props**: {
  "progress": 0.65,
...
- **Dimensions**: width: 200, height: 8
- **Tags**: progress, bar, storage
- **Semantic Fit**: content

#### utilities-ring-battery
- **Category**: progress
...
- **Tags**: progress, ring, circular, battery
- **Semantic Fit**: content

#### utilities-ring-storage
- **Category**: progress
- **Component Type**: ProgressRing
- **Props**: {
  "value": 65,
...
- **Dimensions**: width: 100, height: 100
- **Tags**: progress, ring, circular, storage
- **Semantic Fit**: content

### Text Components

#### utilities-text-title-battery
- **Category**: text
- **Component Type**: Text
- **Props**: {
  "fontSize": 16,
...
#### utilities-text-battery-percent
- **Category**: text
- **Component Type**: Text
- **Props**: {
  "fontSize": 32,
...
- **Content**: "85%"
- **Tags**: text, battery, percentage
- **Semantic Fit**: header,content

#### utilities-text-battery-time
- **Category**: text
- **Component Type**: Text
- **Props**: {
  "fontSize": 14,
...
- **Content**: "3h 25m remaining"
- **Tags**: text, battery, time
- **Semantic Fit**: header,content

#### utilities-text-wifi-connected
- **Category**: text
- **Component Type**: Text
- **Props**: {
  "fontSize": 14,
...
- **Content**: "Connected"
- **Tags**: text, wifi, status
- **Semantic Fit**: header,content

#### utilities-text-storage-available
- **Category**: text
- **Component Type**: Text
- **Props**: {
  "fontSize": 14,
