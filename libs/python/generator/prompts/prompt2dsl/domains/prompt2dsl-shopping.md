...
The following pre-built components are available for shopping widgets. You can reference these components by their exact ID to ensure consistent styling and behavior.

### Button Components

#### shopping-button-add-cart
- **Category**: button
...
#### shopping-composite-product-card
- **Category**: composite
- **Component Type**: undefined
- **Tags**: composite, product, card
- **Semantic Fit**: content,header

#### shopping-composite-cart-item
- **Category**: composite
- **Component Type**: undefined
- **Tags**: composite, cart, item
- **Semantic Fit**: content,header
...
#### shopping-icon-creditcard-green-20
- **Category**: icon
- **Component Type**: Icon
- **Props**: {
...
- **Tags**: icon, sale, price
- **Semantic Fit**: header,content,sidebar

#### shopping-icon-gift-purple-20
- **Category**: icon
- **Component Type**: Icon
- **Props**: {
  "name": "sf:gift.fill",
...
- **Tags**: icon, wishlist, favorite
- **Semantic Fit**: header,content,sidebar

#### shopping-icon-box-brown-20
- **Category**: icon
- **Component Type**: Icon
- **Props**: {
  "name": "sf:shippingbox.fill",
  "size": 20,
  "color": "#8B4513"
}
- **Tags**: icon, delivery, package
- **Semantic Fit**: header,content,sidebar

#### shopping-icon-truck-blue-20
- **Category**: icon
- **Component Type**: Icon
- **Props**: {
  "name": "sf:truck.box.fill",
  "size": 20,
  "color": "#007AFF"
}
- **Tags**: icon, shipping, delivery
- **Semantic Fit**: header,content,sidebar

#### shopping-icon-checkmark-green-20
- **Category**: icon
- **Component Type**: Icon
- **Props**: {
...
#### shopping-image-product-thumbnail
- **Category**: image
- **Component Type**: Image
- **Props**: {
  "src": "https://via.placeholder.com/150",
...
- **Tags**: indicator, status, sale
- **Semantic Fit**: sidebar,content

#### shopping-indicator-new
- **Category**: indicator
- **Component Type**: Indicator
- **Props**: {
  "color": "#007AFF"
...
- **Dimensions**: width: 4, height: 100%
- **Tags**: indicator, status, new
- **Semantic Fit**: sidebar,content

### Progress Components

#### shopping-progress-delivery
- **Category**: progress
...
- **Dimensions**: width: 200, height: 4
- **Tags**: progress, bar, delivery
- **Semantic Fit**: content

### Text Components

#### shopping-text-title-cart
- **Category**: text
- **Component Type**: Text
- **Props**: {
  "fontSize": 18,
...
- **Content**: "$79.99"
- **Tags**: text, price, sale
- **Semantic Fit**: header,content

#### shopping-text-original-price
- **Category**: text
- **Component Type**: Text
- **Props**: {
  "fontSize": 14,
...
- **Content**: "$99.99"
- **Tags**: text, price, original
- **Semantic Fit**: header,content

#### shopping-text-save-20
- **Category**: text
- **Component Type**: Text
- **Props**: {
  "fontSize": 12,
...
- **Content**: "In Stock"
- **Tags**: text, stock, status
- **Semantic Fit**: header,content

#### shopping-text-out-stock
- **Category**: text
- **Component Type**: Text
- **Props**: {
  "fontSize": 12,
...
- **Content**: "Total: $249.98"
- **Tags**: text, total, price
- **Semantic Fit**: header,content

#### shopping-text-rating-4-5
- **Category**: text
- **Component Type**: Text
- **Props**: {
  "fontSize": 14,
