...
The following pre-built components are available for smart-home widgets. You can reference these components by their exact ID to ensure consistent styling and behavior.

### Button Components

#### smart-home-button-unlock
- **Category**: button
...
- **Content**: "Unlock"
- **Tags**: button, action, action, lock
- **Semantic Fit**: header,footer,content

#### smart-home-button-all-off
- **Category**: button
- **Component Type**: Button
- **Props**: {
  "variant": "secondary",
...
#### smart-home-composite-device-row
- **Category**: composite
- **Component Type**: undefined
- **Tags**: composite, device, row
- **Semantic Fit**: content,header

#### smart-home-composite-thermostat
- **Category**: composite
- **Component Type**: undefined
- **Tags**: composite, thermostat, temperature
- **Semantic Fit**: content,header
...
#### smart-home-icon-lightbulb
- **Category**: icon
- **Component Type**: Icon
- **Props**: {
  "name": "sf:lightbulb.fill",
  "size": 20,
  "color": "#FFCC00"
}
- **Tags**: icon, light
...
- **Tags**: icon, security, lock
- **Semantic Fit**: header,content,sidebar

#### smart-home-icon-thermometer
- **Category**: icon
- **Component Type**: Icon
- **Props**: {
...
- **Tags**: icon, fan, climate
- **Semantic Fit**: header,content,sidebar

### Indicator Components

#### smart-home-indicator-on
- **Category**: indicator
...
- **Tags**: indicator, status, status, on
- **Semantic Fit**: sidebar,content

#### smart-home-indicator-off
- **Category**: indicator
- **Component Type**: Indicator
- **Props**: {
  "color": "#8E8E93"
...
- **Dimensions**: width: 4, height: 40
- **Tags**: indicator, status, status, off
- **Semantic Fit**: sidebar,content

### Progress Components

#### smart-home-progress-brightness
- **Category**: progress
...
- **Tags**: progress, bar, brightness, light
- **Semantic Fit**: content

#### smart-home-progress-temperature
- **Category**: progress
- **Component Type**: ProgressBar
- **Props**: {
  "progress": 0.6,
...
- **Dimensions**: width: 150, height: 8
- **Tags**: progress, bar, temperature
- **Semantic Fit**: content

### Text Components

#### smart-home-text-title-home
- **Category**: text
- **Component Type**: Text
- **Props**: {
  "fontSize": 16,
...
#### smart-home-text-device-thermostat
- **Category**: text
- **Component Type**: Text
- **Props**: {
  "fontSize": 15,
