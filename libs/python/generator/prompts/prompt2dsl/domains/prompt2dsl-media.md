...
The following pre-built components are available for media widgets. You can reference these components by their exact ID to ensure consistent styling and behavior.
...
- **Content**: "Play"
- **Tags**: button, action, play
- **Semantic Fit**: header,footer,content

#### media-button-shuffle
- **Category**: button
- **Component Type**: Button
- **Props**: {
  "variant": "secondary",
...
- **Content**: "Shuffle"
- **Tags**: button, action, shuffle
- **Semantic Fit**: header,footer,content

### Composite Components

#### media-composite-now-playing
- **Category**: composite
- **Component Type**: undefined
- **Tags**: composite, now-playing
- **Semantic Fit**: content,header

#### media-composite-playback-controls
- **Category**: composite
- **Component Type**: undefined
- **Tags**: composite, controls
- **Semantic Fit**: content,header

#### media-composite-time-progress
- **Category**: composite
- **Component Type**: undefined
- **Tags**: composite, time, progress
- **Semantic Fit**: content,header
...
- **Tags**: image, album, cover
- **Semantic Fit**: content,sidebar

#### media-image-album-art-small
- **Category**: image
- **Component Type**: Image
- **Props**: {
  "src": "https://via.placeholder.com/150",
...
- **Dimensions**: width: 250, height: 4
- **Tags**: progress, bar, playback, scrubber
- **Semantic Fit**: content

#### media-progress-volume
- **Category**: progress
- **Component Type**: ProgressBar
- **Props**: {
  "progress": 0.7,
...
- **Tags**: progress, bar, volume
- **Semantic Fit**: content

### Text Components

#### media-text-title-music
- **Category**: text
- **Component Type**: Text
- **Props**: {
  "fontSize": 16,
