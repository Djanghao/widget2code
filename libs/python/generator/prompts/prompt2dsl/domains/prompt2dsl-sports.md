...
The following pre-built components are available for sports widgets. You can reference these components by their exact ID to ensure consistent styling and behavior.

### Button Components

#### sports-button-view-game
- **Category**: button
...
- **Tags**: chart, bar, comparison, points, stats
- **Semantic Fit**: content

#### sports-chart-win-loss
- **Category**: chart
...
- **Tags**: chart, pie, proportions, record, win-loss
- **Semantic Fit**: content

### Composite Components

#### sports-composite-game-score
- **Category**: composite
- **Component Type**: undefined
- **Tags**: composite, game, score
- **Semantic Fit**: content,header

#### sports-composite-team-row
- **Category**: composite
- **Component Type**: undefined
- **Tags**: composite, team, row
- **Semantic Fit**: content,header

#### sports-composite-live-status
- **Category**: composite
- **Component Type**: undefined
- **Tags**: composite, status, live
- **Semantic Fit**: content,header

#### sports-composite-player-stat
- **Category**: composite
- **Component Type**: undefined
- **Tags**: composite, player, stats
- **Semantic Fit**: content,header
...
- **Tags**: icon, trophy, win
- **Semantic Fit**: header,content,sidebar

#### sports-icon-football
- **Category**: icon
- **Component Type**: Icon
- **Props**: {
  "name": "sf:football.fill",
  "size": 20,
  "color": "#8E8E93"
}
- **Tags**: icon, football
...
- **Component Type**: Icon
- **Props**: {
  "name": "sf:basketball.fill",
  "size": 20,
  "color": "#FF9500"
}
- **Tags**: icon, basketball
- **Semantic Fit**: header,content,sidebar
...
- **Tags**: icon, streak, hot
- **Semantic Fit**: header,content,sidebar

### Image Components

#### sports-image-team-logo
- **Category**: image
...
- **Tags**: image, team, logo
- **Semantic Fit**: content,sidebar

### Text Components

#### sports-text-title-scores
- **Category**: text
- **Component Type**: Text
- **Props**: {
  "fontSize": 16,
...
- **Content**: "LIVE"
- **Tags**: text, status, live
- **Semantic Fit**: header,content

#### sports-text-status-final
- **Category**: text
- **Component Type**: Text
- **Props**: {
  "fontSize": 12,
