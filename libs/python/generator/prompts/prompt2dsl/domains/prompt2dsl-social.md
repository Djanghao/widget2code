...
The following pre-built components are available for social widgets. You can reference these components by their exact ID to ensure consistent styling and behavior.
...
- **Content**: "Follow"
- **Tags**: button, action, action, follow
- **Semantic Fit**: header,footer,content

#### social-button-following
- **Category**: button
- **Component Type**: Button
- **Props**: {
  "variant": "secondary",
...
- **Content**: "Following"
- **Tags**: button, action, action, unfollow
- **Semantic Fit**: header,footer,content

#### social-button-message
- **Category**: button
- **Component Type**: Button
- **Props**: {
  "variant": "secondary",
...
- **Tags**: button, action, action, edit
- **Semantic Fit**: header,footer,content

### Composite Components

#### social-composite-post
- **Category**: composite
- **Component Type**: undefined
- **Tags**: composite, post, feed
- **Semantic Fit**: content,header

#### social-composite-profile-stats
- **Category**: composite
- **Component Type**: undefined
- **Tags**: composite, profile, stats
- **Semantic Fit**: content,header

#### social-composite-story
- **Category**: composite
- **Component Type**: undefined
- **Tags**: composite, story, avatar
- **Semantic Fit**: content,header
...
- **Tags**: icon, like, favorite
- **Semantic Fit**: header,content,sidebar

#### social-icon-heart-gray-18
- **Category**: icon
- **Component Type**: Icon
- **Props**: {
  "name": "sf:heart",
...
- **Tags**: icon, comment, message
- **Semantic Fit**: header,content,sidebar

#### social-icon-paperplane-blue-20
- **Category**: icon
- **Component Type**: Icon
- **Props**: {
...
- **Tags**: icon, share, send
- **Semantic Fit**: header,content,sidebar

#### social-icon-bookmark-yellow-18
- **Category**: icon
- **Component Type**: Icon
- **Props**: {
  "name": "sf:bookmark.fill",
  "size": 18,
  "color": "#FFCC00"
}
- **Tags**: icon, save, bookmark
- **Semantic Fit**: header,content,sidebar

#### social-icon-person-gray-20
- **Category**: icon
- **Component Type**: Icon
- **Props**: {
  "name": "sf:person.fill",
...
- **Tags**: icon, profile, user
- **Semantic Fit**: header,content,sidebar

#### social-icon-person-2-purple-20
- **Category**: icon
- **Component Type**: Icon
- **Props**: {
...
- **Tags**: icon, followers, friends
- **Semantic Fit**: header,content,sidebar

#### social-icon-person-add-blue-18
- **Category**: icon
- **Component Type**: Icon
- **Props**: {
  "name": "sf:person.badge.plus",
  "size": 18,
  "color": "#007AFF"
}
- **Tags**: icon, follow, add
- **Semantic Fit**: header,content,sidebar

#### social-icon-star-yellow-20
- **Category**: icon
- **Component Type**: Icon
- **Props**: {
  "name": "sf:star.fill",
...
- **Tags**: icon, favorite, featured
- **Semantic Fit**: header,content,sidebar

#### social-icon-eye-gray-18
- **Category**: icon
- **Component Type**: Icon
- **Props**: {
  "name": "sf:eye.fill",
...
- **Tags**: icon, views, seen
- **Semantic Fit**: header,content,sidebar

#### social-icon-checkmark-blue-16
- **Category**: icon
- **Component Type**: Icon
- **Props**: {
  "name": "sf:checkmark.seal.fill",
  "size": 16,
  "color": "#007AFF"
}
- **Tags**: icon, verified, badge
- **Semantic Fit**: header,content,sidebar

#### social-icon-photo-blue-20
- **Category**: icon
- **Component Type**: Icon
- **Props**: {
  "name": "sf:photo.fill",
...
- **Tags**: icon, photo, media
- **Semantic Fit**: header,content,sidebar

### Image Components

#### social-image-post-square
- **Category**: image
...
- **Tags**: image, post, photo
- **Semantic Fit**: content,sidebar

#### social-image-story-circle
- **Category**: image
- **Component Type**: Image
- **Props**: {
  "src": "https://via.placeholder.com/150",
...
- **Tags**: image, story, avatar
- **Semantic Fit**: content,sidebar

#### social-image-avatar-40
- **Category**: image
- **Component Type**: Image
- **Props**: {
  "src": "https://via.placeholder.com/150",
...
- **Tags**: indicator, status, live, active
- **Semantic Fit**: sidebar,content

#### social-indicator-blue
- **Category**: indicator
- **Component Type**: Indicator
- **Props**: {
  "color": "#007AFF"
...
- **Dimensions**: width: 4, height: 100%
- **Tags**: indicator, status, story, unread
- **Semantic Fit**: sidebar,content

### Progress Components

#### social-progress-story
- **Category**: progress
...
- **Tags**: progress, bar, story, progress
- **Semantic Fit**: content

### Text Components

#### social-text-title-feed
- **Category**: text
- **Component Type**: Text
- **Props**: {
  "fontSize": 18,
...
- **Content**: "Product designer & coffee lover ☕"
- **Tags**: text, bio, description
- **Semantic Fit**: header,content
...
- **Content**: "125 likes"
- **Tags**: text, likes, engagement
- **Semantic Fit**: header,content

#### social-text-likes-1-2k
- **Category**: text
- **Component Type**: Text
- **Props**: {
  "fontSize": 13,
...
- **Content**: "2.5K"
- **Tags**: text, followers, count
- **Semantic Fit**: header,content

#### social-text-following-342
- **Category**: text
- **Component Type**: Text
- **Props**: {
  "fontSize": 16,
...
- **Content**: "342"
- **Tags**: text, following, count
- **Semantic Fit**: header,content

#### social-text-posts-128
- **Category**: text
- **Component Type**: Text
- **Props**: {
  "fontSize": 16,
...
- **Content**: "128"
- **Tags**: text, posts, count
- **Semantic Fit**: header,content

#### social-text-label-followers
- **Category**: text
- **Component Type**: Text
- **Props**: {
  "fontSize": 12,
