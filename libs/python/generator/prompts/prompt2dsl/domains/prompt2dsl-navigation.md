...
The following pre-built components are available for navigation widgets. You can reference these components by their exact ID to ensure consistent styling and behavior.
...
#### navigation-button-share-location
- **Category**: button
- **Component Type**: Button
- **Props**: {
  "variant": "secondary",
...
#### navigation-composite-location-card
- **Category**: composite
- **Component Type**: undefined
- **Tags**: composite, location, card
- **Semantic Fit**: content,header

#### navigation-composite-route-info
- **Category**: composite
- **Component Type**: undefined
- **Tags**: composite, route, eta
- **Semantic Fit**: content,header
...
- **Tags**: icon, direction, north
- **Semantic Fit**: header,content,sidebar

### Image Components

#### navigation-map-large
- **Category**: image
