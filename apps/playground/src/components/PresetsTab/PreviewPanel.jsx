...
export default function PreviewPanel({
  ...
  const handleDragResize = (e) => {
    ...
    const onUp = () => {
      ...
      console.log(
        `🖱️ [Drag End] Final size: ${finalW}×${finalH}, writing back to spec...`
      );
      ...
      >
        ...
        >
              ...
              onClick={() => {
                ...
                if (newValue && widgetDSL) {
                  ...
                  if (
                    ...
                    console.log(
                      `⚡ [AutoResize Toggle] Executing auto-resize with ratio: ${aspectRatio}`
                    );
          ...
          <button
            ...
            onMouseLeave={(e) => {
              if (!isLocked) e.currentTarget.style.backgroundColor = "#2c2c2e";
            }}
          ...
          <button
            ...
            onMouseLeave={(e) =>
              !isLocked && (e.currentTarget.style.backgroundColor = "#2c2c2e")
            }
